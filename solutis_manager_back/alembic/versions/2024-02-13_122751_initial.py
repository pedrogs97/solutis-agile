...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_group_id"],
            ["asset_types_totvs.id"],
        ),
        sa.ForeignKeyConstraint(
            ["clothing_size_id"],
            ["asset_clothing_size.id"],
        ),
        sa.ForeignKeyConstraint(
            ["status_id"],
            ["asset_status.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["marital_status_id"],
            ["marital_status_totvs.id"],
        ),
        sa.ForeignKeyConstraint(
            ["nationality_id"],
            ["nationalities_totvs.id"],
        ),
        sa.ForeignKeyConstraint(
            ["role_id"],
            ["roles_totvs.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "logged_in", sa.DateTime(), server_default=sa.text("now()"), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["user.id"],
