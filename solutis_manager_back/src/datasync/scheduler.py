...
class SchedulerService:
    ...
    pc.IMEI, pc.IMEI02, pc.ACESSORIOS01, pc.OPERADORA01, pc.SISTEMAOPERACIONAL, pc.PACOTEOFFICE,
    pc.PADRAOEQUIP01, ga.DATAEXPIRACAO AS GARANTIA, pc.MANUT5 AS LINHA,
    ...
    SQL_IPATRIMONIO_TO_DELETE = (
        """SELECT IDPATRIMONIO FROM IPATRIMONIO WHERE IDPATRIMONIO = %s"""
    )
