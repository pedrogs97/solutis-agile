...
interface MobileClothingCardProps {
...
function MobileClothingCardComponent({
  term,
  accentColor,
  primaryTextColor,
  secondaryTextColor,
  cardBackground,
  handleChangeRadio,
}: Readonly<MobileClothingCardProps>) {
  return (
